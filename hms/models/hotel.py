...
class Property(models.Model):
    ...
    def create(self, values):
        ...
        return res
        # room_type=res.roomtype_ids
        # _logger.info('#############################')
        # _logger.info('CREATE ROOM TYPE = %s',room_type)
    ...
    def write(self,values):
        ...
        if 'roomtype_ids' in values.keys():
            ...
            # old_objs = self.availability_ids[0].room_availability_ids.mapped('room_type')
            # _logger.info('###################')
            # _logger.info('Old Objects = %s',old_objs )
